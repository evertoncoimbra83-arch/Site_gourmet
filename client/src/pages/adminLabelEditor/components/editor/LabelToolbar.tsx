    ...
    <div className="animate-in space-y-4 text-left fade-in slide-in-from-left-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button
            variant="outline"
            onClick={() => onAdd("variable", "{{NOME_PRATO}}", 12, 80)}
            className="h-8 justify-start bg-white px-2 text-[9px] font-bold"
          >
          ...
          <Button
            variant="outline"
            onClick={() => onAdd("variable", "{{ACOMPANHAMENTOS}}", 9, 90)}
            className="h-8 justify-start bg-white px-2 text-[9px] font-bold"
          >
          ...
          <Button
            ...
            className="col-span-1 h-8 justify-start bg-slate-900 px-2 text-[9px] font-black text-emerald-400 shadow-md hover:bg-black"
          >
