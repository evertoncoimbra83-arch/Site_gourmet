...
import { Save, Loader2, TrendingUp, Target, Users, Star } from "lucide-react";
  ...
  return (
    <div className="space-y-10 pb-20 px-4 md:px-0 text-left">
      ...
      <LoyaltyHistoryDrawer 
        ...
        onDelete={actions.handleDeleteTransaction} // ATENÇÃO: Verifique se o nome no seu hook é esse mesmo!
      />
    </div>
  );
}