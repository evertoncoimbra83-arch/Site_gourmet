    ...
    <div className={cn(
      ...
      <button 
        ...
        className={cn(
          ...
          "border border-white/10 pl-4 pr-2 py-2 rounded-full",
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-black uppercase tracking-widest text-[10px] hidden sm:inline italic">
            Meu Carrinho
          </span>
        </div>

        <div className="flex items-center gap-2 bg-emerald-500 text-slate-900 px-4 py-2 rounded-full font-black uppercase text-[10px] tracking-tighter italic shadow-lg shadow-emerald-500/20 group-hover:bg-emerald-400 transition-colors">
