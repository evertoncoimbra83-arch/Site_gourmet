...
export const publicRoutes: RouteConfig[] = [
  ...
  { path: "/auth/callback", element: lazy(() => import("../../pages/auth/OAuthCallbackPage")) },
];
...
export const adminRoutes: RouteConfig[] = [
  ...
  { path: "pdv", element: lazy(() => import("../../pages/AdminPdvDisabled")) },
  { path: "pdv/comanda/:id", element: lazy(() => import("../../pages/AdminPdvDisabled")) },
  { path: "pdv/relatorios", element: lazy(() => import("../../pages/AdminPdvDisabled")) },
  ...
  { path: "workers", element: lazy(() => import("../../pages/AdminWorkers")), role: ["super_admin", "admin"] },
];
