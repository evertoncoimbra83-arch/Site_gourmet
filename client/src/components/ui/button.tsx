...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    // ✅ O comentário abaixo desliga o alerta do ESLint APENAS para esta linha.
    // Isso silencia o erro do bigint no TS e o erro de "no-explicit-any" do ESLint juntos!
